...
<div style="width: 20%; margin:auto; margin-top:50px">
    <form  class="shadow bg-white rounded p-3 " action="/student034/dwes/db/customers/db_customer_update.php" method="post" enctype="multipart/form-data">
        ...
        <p>DNI</p><input type="text" name="client_DNI" value="<?php echo $client_info[0]['client_DNI']; ?>" accept="image/png, image/jpg"></input>
        <p>PICTURE DNI</p><input type="file" name="foto_dni" value="<?php echo $client_info[0]['client_DNI']; ?>" accept="image/png, image/jpg"></input>
        <p>Avatar Foto</p><input type="file" name="client_avatar" value="<?php echo $client_info[0]['client_avatar']; ?>" accept="image/png, image/jpg"></input>
