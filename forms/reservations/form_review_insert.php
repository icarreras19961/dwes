...
<div style="width: 30%; margin:auto; margin-top:50px">
  <form class="shadow bg-white rounded" action="/student034/dwes/db/reservations/db_review_insert.php" method="POST">
    ...
    <div class="form-group">
      <label class="m-2"> <input class="form-control" type="text" 
      value="<?php print_r($_POST["client_id"])?>"
      name="client_id" ></label>
    </div>
    <div class="form-group">
      <label class="m-2"> <input class="form-control" type="text" value="<?php print_r($_POST["reservation_id"])?>" name="reservation_id" ></label>
    </div>
